...
<div class="mb-3">
    <label  class="fw-bold">Date In Position</label><span class="text-danger fw-bold">*</span>
...
<div class="mb-3">
    <label  class="fw-bold">Date Joined</label><span class="text-danger fw-bold">*</span>
