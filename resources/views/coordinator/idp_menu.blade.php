...
<button type="button" class="bg-laravel text-white rounded py-5 px-20 hover:bg-black rounded-lg">
    <a href="{{route('idp.index')}}">Approved Individual Development Plan</a>
</button>



<button type="button" class="bg-laravel text-white rounded py-5 px-20 hover:bg-black rounded-lg">
    <a href="{{route('idp.queue')}}">Submitted Individual Development Plan</a>
</button>

<button type="button" class="bg-laravel text-white rounded py-5 px-20 hover:bg-black rounded-lg">
    <a href="{{route('idp.empindex')}}">My Individual Development Plan</a>
</button>
    </div>
</div>
