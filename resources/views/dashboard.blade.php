      ...
      <div class="card h-100 border border-5 border-light shadow-lg">
        ...
        <div class="card-body">
          ...
          <ul class="dropdown-menu rounded-3 border-light border-3" style="background-image: linear-gradient(to right, #ADA996, #F2F2F2, #DBDBDB, #EAEAEA);">
            <li><button class="dropdown-item fw-bolder text-dark" wire:click="createTraining">Upload Training</a></li>
            <li><button class="dropdown-item fw-bolder text-dark" wire:click="myTraining">My Training/s</a></li>
