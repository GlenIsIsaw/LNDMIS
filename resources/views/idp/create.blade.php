            ...
            <div class="mx-4">
                    ...
                    <form method="POST" action="{{route('idp.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <label for="purpose_others">Others, please specify: </label><input type="text" class="border border-gray-200" name="explain" value = "{{old('explain')}}"
                        /><br>
                        <table>
                        ...
                        <div class="mb-6">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <select name="compfunction2" id="compfunctiondesc">
                                            <option value=""> </option>
                                            @foreach ($comps as $key => $comp)
                                            <optgroup label={{$key}}>
                                                @foreach ($comp as $item)
                        ...
                        <div class="mb-6">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <select name="diffunction2" id="diffunctiondesc">
                                            <option value=""> </option>
                                            @foreach ($comps as $key => $comp)
                                            <optgroup label={{$key}}>
                                                @foreach ($comp as $item)
