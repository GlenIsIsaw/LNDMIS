    ...
    public function printAll(){
        ...
        //if (!$listObject->isEmpty() && !$listObject2->isEmpty()) {
            ...
            foreach($list as $group) 
            {
                ...
                {
                    $values[] = array(
                        "certificate_title_{$i}" => TrainingShow::xmlEntities(htmlentities($row['certificate_title'])),
            ...
            foreach($list as $group) 
            {
                ...
                {
                    $values[] = array(
                        "certificate_title2_{$i}" => TrainingShow::xmlEntities(htmlentities($row['certificate_title'])),
