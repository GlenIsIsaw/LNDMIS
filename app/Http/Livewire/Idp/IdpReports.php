    ...
    public function printall(){
        ...
        foreach($list as $name => $group) 
        {
            ...
            $templateProcessor->setValues(array(
                ...
                "devact0#$i" => TrainingShow::xmlEntities(htmlentities($dev[0])),
                "devact1#$i" => TrainingShow::xmlEntities(htmlentities($dev[1])),
                "devact2#$i" => TrainingShow::xmlEntities(htmlentities($dev[2])),
    ...
    public function printTnmReports(){
        ...
        foreach ($highest as $num => $value) {
            foreach ($value as $key => $item) {
                $highest[$num][$key] = TrainingShow::xmlEntities(htmlentities($item));
            }
        }
